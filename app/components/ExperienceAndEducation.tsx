...
const items = [
  {
    title: "Actually working in ADV Technology",
    description: (
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Including more than half of required and optional credits and english suficent proof.
      </span>
    ),
    header: <SkeletonTwo />,
    className: "md:col-span-1",
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Earned in extra courses and online tests.
      </span>
    ),
    header: <SkeletonFour />,
  ...
  {
    title: "Technical skills I want to improve and learn by myself",
    description: (
      <span className="text-sm">
